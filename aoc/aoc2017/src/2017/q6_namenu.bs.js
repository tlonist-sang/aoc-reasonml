...
var input = Belt_Array.map(Fs.readFileSync("input/q6in.txt", "utf8").trim().split("\t"), Caml_format.caml_int_of_string);

function distributeUnsafe(banks) {
  var i = Garter$Aoc2017.$$Array.maxIndex(banks);
  ...
  while(true) {
    ...
    Garter$Aoc2017.$$Array.updateUnsafe(banks, j, (function (param) {
            return 1 + param | 0;
          }));
